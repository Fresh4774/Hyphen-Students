                ...
                <div className="mt-8">
                    <section>
                        ...
                        <div className="space-y-6 mb-10">
                            ...
                            <div>
                                <p className="text-base mb-3"><strong className="text-black">Teachers Side App</strong></p>
                            </div>

                            <div>
                                <p className="text-base mb-3"><strong className="text-black">Teacher-Student Communications In School</strong></p>
                            </div>
